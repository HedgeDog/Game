...
namespace xnaplatformer
{
    public class Tile
    {
        ...
        public void UpdateCollision(ref Entity e)
        {
            ...
            //    if ((e.Rect.Right + 2000 < rect.Left || e.Rect.Left > 2000 + rect.Right || e.Rect.Bottom < rect.Top))
            //    {
            //        e.OnTile = false;
            //        containsEntity = false; 
            ...
            //    }
            //}
            FloatRect preve = new FloatRect(e.PrevPostion.X, e.PrevPostion.Y, e.Animation.FrameWidth(), e.Animation.FrameHeight());
            ...
            if (e.Rect.intersects(rect) && state == State.Solid)
            {
                ...
                {
                    e.Position = new Vector2(position.X - e.Animation.FrameWidth() - 3, e.Position.Y);
